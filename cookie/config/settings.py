...
class Common(Configuration):
    ...
    ADMINS = (
        ('fabio', 'fabio.ar.rodrigues@gmailcom'),
    )
    ...
    DATABASES = values.DatabaseURLValue('postgres://localhost/cookie')
...
class Production(Common):
    ...
    DEFAULT_FROM_EMAIL = values.Value(
            'cookiecutter <noreply@aoh.com>')
    EMAIL_HOST = values.Value('smtp.sendgrid.com')
    EMAIL_HOST_PASSWORD = values.SecretValue(environ_prefix="", environ_name="SENDGRID_PASSWORD")
    EMAIL_HOST_USER = values.SecretValue(environ_prefix="", environ_name="SENDGRID_USERNAME")
    EMAIL_PORT = values.IntegerValue(587, environ_prefix="", environ_name="EMAIL_PORT")
    EMAIL_SUBJECT_PREFIX = values.Value('[cookiecutter] ', environ_name="EMAIL_SUBJECT_PREFIX")
    EMAIL_USE_TLS = True
